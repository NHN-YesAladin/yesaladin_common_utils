...
public enum ErrorCode {
    ...
    ISSUED_COUPON_NOT_FOUND("요청한 쿠폰이 모두 소진되었습니다.", HttpStatus.NOT_FOUND),
    COUPON_GROUP_NOT_FOUND("쿠폰 그룹이 존재하지 않습니다.", HttpStatus.NOT_FOUND),
    COUPON_BOUND_NOT_FOUND("쿠폰의 할인 적용 범위가 존재하지 않습니다.", HttpStatus.NOT_FOUND),
    COUPON_POLICY_NOT_FOUND("쿠폰의 정책이 존재하지 않습니다.", HttpStatus.NOT_FOUND),
